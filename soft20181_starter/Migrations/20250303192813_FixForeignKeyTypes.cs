        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VenueName = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    VenueAddress = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    OrganizerName = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    OrganizerContact = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    FollowLink = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    TicketPrice = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    Currency = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
                    EventLink = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserID = table.Column<Guid>(type: "TEXT", nullable: false),
                    EventID = table.Column<int>(type: "INTEGER", nullable: false),
                    TicketGenerated = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserID = table.Column<Guid>(type: "TEXT", nullable: false),
                    EventID = table.Column<int>(type: "INTEGER", nullable: false),
                    TicketCode = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
